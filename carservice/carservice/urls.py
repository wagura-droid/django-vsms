...
urlpatterns = [
    ...
    path('mechanicsignup', views.mechanicsignup_view, name='mechanicsignup'),

    path('customerlogin', LoginView.as_view(template_name='vehicle/customer/customerlogin.html'), name='customerlogin'),
    path('mechaniclogin', LoginView.as_view(template_name='vehicle/mechanic/mechaniclogin.html'), name='mechaniclogin'),
    path('adminlogin', LoginView.as_view(template_name='vehicle/admin/adminlogin.html'), name='adminlogin'),
    ...
    path('logout', LogoutView.as_view(template_name='vehicle/main/index.html'), name='logout'),
