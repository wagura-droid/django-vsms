...
class RequestForm(forms.ModelForm):
    class Meta:
        ...
        widgets    = {
            'problem-description' : forms.Textarea(attrs={'rows': 3, 'cols': 30})
        }

class AdminRequestForm(forms.Form):
    #  to_field_name value will be stored when form is submitted...  __str__ method 0f customer model will be show in html
