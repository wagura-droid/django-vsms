...
def home_view(request):
    ...
    return render(request, 'vehicle/main/index.html')

#  Shows signup/login button for customer
def customerclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request, 'vehicle/customer/customerclick.html')

# Shows signup/login button for mechanics
def mechanicsclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request, 'vehicle/mechanic/mechanicsclick.html')
...
def customersignup_view(request):
    ...
    return render(request, 'vehicle/customer/customersignup.html', context=mydict)

def mechanicsignup_view(request):
    ...
    if request.method =='POST':
        ...
        if userForm.is_valid() and mechanicForm.is_valid():
            ...
            mechanic.user   = user
            mechanic.save()
            mechanic_group  = Group.objects.get_or_create(name='MECHANIC')
            mechanic_group[0].user_set.add(user)
        return HttpResponseRedirect('mechaniclogin')
    return render(request, 'vehicle/mechanic/mechanicsignup.html',context=mydict)

# Checks user customer, mechanic or admin
...
def afterlogin_view(request):
    if is_customer(request.user):
        ...
        if accountapproval:
            ...
            return render(request, 'vehicle/mechanic/mechanic_wait_for_approval.html', )
    else:
...
def admin_dashboard_view(request):
    ...
    return render(request, 'vehicle/admin/admin_dashboard.html',context=dict)
    
@login_required(login_url='adminlogin')
def admin_customer_view(request):
    customers       = models.Customer.objects.all()
    return render(request, 'vehicle/admin/admin_customer.html', {'customers':customers})

@login_required(login_url='adminlogin')
def admin_view_customer_view(request):
    customers       = models.Customer.objects.all()
    return render(request, 'vehicle/admin/admin_view_customer.html',{'customers':customers})
...
def update_customer_view(request,pk):
    ...
    customerForm    = forms.CustomerForm(request.FILES, instance=user)
    mydict          = {'userForm':userForm,'customerForm':customerForm}
    if request.method == 'POST':
        ...
        if userForm.is_valid() and customerForm.is_valid():
            ...
            customerForm.save()
            return redirect('admin-view-customer')
    return render(request, 'vehicle/customer/update_customer.html', context=mydict)
...
def admin_add_customer_view(request):
    ...
    return render(request, 'vehicle/admin/admin_add_customer.html', context=mydict)
...
def admin_view_customer_enquiry_view(request):
    ...
    for enq in enquiry:
        customer    = models.Customer.objects.get(id=enq.customer_id)
        customers.append(customer)
    return render(request, 'vehicle/admin/admin_view_customer_enquiry.html',{'data':zip(customers,enquiry)})
...
def admin_view_customer_invoice_view(request):
    ...
    for enq in enquiry:
        ...
        customer    = models.Customer.objects.get(id=enq['customer_id'])
        customers.append(customer)
    return render(request, 'vehicle/admin/admin_view_customer_invoice.html', {'data':zip(customers,enquiry)})

@login_required(login_url='adminlogin')
def admin_mechanic_view(request):
    return render(request, 'vehicle/admin/admin_mechanic.html')

@login_required(login_url='adminlogin')
def admin_approve_mechanic_view(request):
    mechanics   = models.Mechanic.objects.all().filter(status=False)
    return render(request, 'vehicle/admin/admin_approve_mechanic.html',{'mechanics':mechanics})
...
def approve_mechanic_view(request,pk):
    ...
    return render(request, 'vehicle/admin/admin_approve_mechanic_details.html', {'mechanicSalary':mechanicSalary})
...
def admin_add_mechanic_view(request):
    ...
    if request.method  == 'POST':
        ...
        if userForm.is_valid() and mechanicForm.is_valid() and mechanicSalary.is_valid():
            ...
            print('Problem in the form')
    return render(request, 'vehicle/admin/admin_add_mechanic.html', context=mydict)

@login_required(login_url='adminlogin')
def admin_view_mechanic_view(request):
    mechanics       = models.Mechanic.objects.all()
    return render(request, 'vehicle/admin/admin_view_mechanic.html', {'mechanics':mechanics})
...
def update_mechanic_view(request,pk):
    ...
    if request.method  == 'POST':
        ...
        if userForm.is_valid() and mechanicForm.is_valid():
            ...
            mechanicForm.save()
            return redirect('admin-view-mechanic')
    return render(request, 'vehicle/mechanic/update_mechanic.html', context=mydict)

@login_required(login_url='adminlogin')
def admin_view_mechanic_salary_view(request):
    mechanics       = models.Mechanic.objects.all()
    return render(request, 'vehicle/admin/admin_view_mechanic_salary.html', {'mechanics':mechanics})
...
def admin_request_view(request):
    return render(request, 'vehicle/admin/admin_request.html')
...
def admin_view_request_view(request):
    ...
    for enq in enquiry:
        customer    = models.Customer.objects.get(id=enq.customer_id)
        customers.append(customer)
    return render(request, 'vehicle/admin/admin_view_request.html', {'data': zip(customers,enquiry)})
...
def change_status_view(request,pk):
    ...
    return render(request, 'vehicle/admin/admin_approve_request_details.html', {'adminenquiry':adminenquiry})
...
def admin_add_request_view(request):
    ...
    if request.method == 'POST':
        ...
        if enquiry.is_valid() and adminenquiry.is_valid():
            ...
            print('Form is Invalid')
        return HttpResponseRedirect('admin-view-request')
    return render(request, 'vehicle/admin/admin_add_request.html', context=mydict)

@login_required(login_url='adminlogin')
def admin_approve_request_view(request):
    enquiry         = models.Request.objects.all().filter(status='Pending')
    return render(request, 'vehicle/admin/admin_approve_request.html', {'enquiry':enquiry})
...
def admin_view_service_cost_view(request):
    ...
    for enq in enquiry:
        ...
        customers.append(customer)
    print(customers)
    return render(request, 'vehicle/admin/admin_view_service_cost.html', {'data':zip(customers,enquiry)})
...
def update_cost_view(request,pk):
    ...
    return render(request, 'vehicle/customer/update_cost.html', {'updateCostForm':updateCostForm})

@login_required(login_url='adminlogin')
def admin_mechanic_attendance_view(request):
    return render(request, 'vehicle/admin/admin_mechanic_attendance.html')
...
def admin_take_attendance_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            print('Form Invalid')
    return render(request, 'vehicle/admin/admin_take_attendance.html',{'mechanics':mechanics, 'form':form})
...
def admin_view_attendance_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'vehicle/admin/admin_view_attendance_page.html', {'mylist':mylist, 'date':date})
        else:
            print('Form Invalid')
    return render(request, 'vehicle/admin/admin_view_attendance_ask_date.html', {'form':form})
...
def admin_report_view(request):
    ...
    return render(request,'vehicle/admin/admin_report.html', context=dict)

@login_required(login_url='adminlogin')
def admin_feedback_view(request):
    feedback    = models.Feedback.objects.all().order_by('-id')
    return render(request, 'vehicle/admin/admin_feedback.html', {'feedback':feedback})
...
def customer_dashboard_view(request):
    ...
    return render(request, 'vehicle/customer/customer_dashboard.html', context=dict)

@login_required(login_url='customerlogin')
@user_passes_test(is_customer)
def customer_request_view(request):
    customer        = models.Customer.objects.get(user_id=request.user.id)
    return render(request, 'vehicle/customer/customer_request.html',{'customer':customer})
...
def customer_view_request_view(request):
    ...
    return render(request, 'vehicle/customer/customer_view_request.html',{'customer':customer, 'enquiries':enquiries})
...
def customer_view_approved_request_view(request):
    ...
    return render(request,'vehicle/customer/customer_view_approved_request.html',{'customer':customer, 'enquiries':enquiries})
...
def customer_view_approved_request_invoice_view(request):
    customer        = models.Customer.objects.get(user_id=request.user.id)
    enquiries       = models.Request.objects.all().filter(customer_id=customer.id).exclude(status="Pending")
    return render(request,'vehicle/customer/customer_view_approved_request_invoice.html',{'customer':customer, 'enquiries':enquiries})
...
def customer_add_request_view(request):
    ...
    return render(request,'vehicle/customer/customer_add_request.html',{'enquiry':enquiry, 'customer':customer})

@login_required(login_url='customerlogin')
@user_passes_test(is_customer)
def customer_profile_view(request):
    customer         = models.Customer.objects.get(user_id=request.user.id)
    return render(request, 'vehicle/customer/customer_profile.html', {'customer':customer})
...
def edit_customer_profile_view(request):
    ...
    return render(request,'vehicle/customer/edit_customer_profile.html', context=mydict)
...
def customer_invoice_view(request):
    customer        = models.Customer.objects.get(user_id=request.user.id)
    enquiries       = models.Request.objects.all().filter(customer_id=customer.id).exclude(status='Pending')
    return render(request, 'vehicle/customer/customer_invoice.html', {'customer':customer, 'enquiries':enquiries})
...
def customer_feedback_view(request):
    ...
    if request.method == 'POST':
        ...
        if feedback.is_valid():
            ...
            print('Form is Invalid')
        return render(request, 'vehicle/customer/feedback_sent_by_customer.html', {'customer':customer})
    return render(request, 'vehicle/customer/customer_feedback.html', {'feedback':feedback, 'customer':customer})
...
def mechanic_dashboard_view(request):
    ...
    return render(request, 'vehicle/mechanic/mechanic_dashboard.html', context=dict)
...
def mechanic_work_assigned_view(request):
    ...
    return render(request,'vehicle/mechanic/mechanic_work_assigned.html', {'works':works, 'mechanic':mechanic})
...
def mechanic_update_status_view(request, pk):
    ...
    return render(request, 'vehicle/mechanic/mechanic_update_status.html', {'updateStatus':updateStatus, 'mechanic':mechanic })

@login_required(login_url='mechaniclogin')
@user_passes_test(is_mechanic)
def mechanic_attendance_view(request):
    mechanic            = models.Mechanic.objects.get(user_id=request.user.id)
    attendances         = models.Attendance.objects.all().filter(mechanic=mechanic)
    return render(request,'vehicle/mechanic/mechanic_view_attendance.html', {'attendances':attendances, 'mechanic':mechanic})
...
def mechanic_feedback_view(request):
    ...
    if request.method == 'POST':
        ...
        if feedback.is_valid():
            ...
            print('Form is Invalid')
        return render(request, 'vehicle/main/feedback_sent.html', {'mechanic':mechanic})
    return render(request,'vehicle/mechanic/mechanic_feedback.html', {'feedback':feedback, 'mechanic':mechanic})
...
def mechanic_salary_view(request):
    ...
    return render(request, 'vehicle/mechanic/mechanic_salary.html', {'workdone':workdone, 'mechanic':mechanic})

@login_required(login_url='mechaniclogin')
@user_passes_test(is_mechanic)
def mechanic_profile_view(request):
    mechanic            = models.Mechanic.objects.get(user_id=request.user.id)
    return render(request,'vehicle/mechanic/mechanic_profile.html', {'mechanic':mechanic})
...
def edit_mechanic_profile_view(request):
    ...
    return render(request, 'vehicle/mechanic/edit_mechanic_profile.html', context=mydict)
...
def aboutus_view(request):
    return render(request, 'vehicle/main/aboutus.html')
...
def contactus_view(request):
    ...
    return render(request, 'vehicle/main/contactus.html', {'form':sub })
